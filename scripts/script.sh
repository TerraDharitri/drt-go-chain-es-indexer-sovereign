...
INDICES_LIST=("rating" "transactions" "blocks" "validators" "miniblocks" "rounds" "accounts" "accountshistory" "receipts" "scresults" "accountsdcdt" "accountsdcdthistory" "epochinfo" "scdeploys" "tokens" "tags" "logs" "delegators" "operations" "dcdts" "values" "events")
