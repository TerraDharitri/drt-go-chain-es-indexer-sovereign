...
func NewSovereignIndexTokensHandler(mainChainElasticClient elasticproc.MainChainDatabaseClientHandler, dcdtPrefix string) (*sovereignIndexTokensHandler, error) {
...
func (sit *sovereignIndexTokensHandler) extractNewSovereignTokens(tokens []string) []string {
	...
	for _, token := range tokens {
		tokenPrefix, hasPrefix := dcdt.IsValidPrefixedToken(token)
		if !hasPrefix || tokenPrefix != sit.dcdtPrefix {
